      ...
      <div className="login-box">
        <section className="welcome-box">
          ...
          <div className="password-requirements">
            ...
            <h1 className="primary">Requisitos para crear tu contraseña</h1>
            <a className={contrasena.length >= 8 ? "success" : null}>
              8 carácteres como mínimo.
            </a>
            <a
            ...
            <Form>
              <Form.Group controlId="formBasicEmail">
                {counterErrors >= 3 && (
                  <>
                    <div className="alert alert-danger" role="alert">
                      Login deshabilitado por intentos fallidos intentelo mas
                      tarde
                    </div>
                    <Form.Control
                      value={email}
                ...
                <Form.Text className="text-muted">
                  Nosotros nunca compartiremos tu correo electrónico con alguien
                  más.
                </Form.Text>
              </Form.Group>
